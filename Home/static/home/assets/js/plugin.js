            ...
            var i = {
                ...
                t = {
                    ...
                    cir: {
                        ...
                        "background-image": "linear-gradient(91deg, transparent 50%, " + i.bgColor + " 50%), linear-gradient(90deg, " + i.bgColor + " 50%, transparent 50%)"
                    },
                    cirCover: {
                        position: "relative",
                        top: i.guage,
                        left: i.guage,
                        "text-align": "center",
                        width: i.diameter - 2 * i.guage,
                        height: i.diameter - 2 * i.guage,
                        "border-radius": "100%",
                        "background-color": i.coverBg
                    },
                    percent: {
                        display: "block",
                        width: i.diameter,
                        height: i.diameter,
                        "line-height": i.diameter + "px",
                        "vertical-align": "middle",
                        "font-size": i.percentSize,
                        "font-weight": i.percentWeight,
                        color: i.fillColor
                    }
                },
                a = this,
                n = '<div><div class="ab"><div class="cir"><span class="perc">{{percentage}}</span></div></div></div>';
            r = e.extend(i, r);
            var o = function(e, i, t) {
                var a = i;
                i <= e && (a >= 180 ? t.css("background-image", "linear-gradient(" + (90 + a) + "deg, transparent 50%, " + r.fillColor + " 50%),linear-gradient(90deg, " + r.fillColor + " 50%, transparent 50%)") : t.css("background-image", "linear-gradient(" + (a - 90) + "deg, transparent 50%, " + r.bgColor + " 50%),linear-gradient(90deg, " + r.fillColor + " 50%, transparent 50%)"), i++, setTimeout(function() {
                    o(e, i, t)
                }, 1))
            };
            a.each(function() {
                var i = e(this),
                    a = Math.round(i.data("percent")),
                    c = 3.6 * a,
                    d = r.animate ? 0 : c,
                    g = e(n.replace("{{percentage}}", a + "%"));
                g.css(t.cirContainer).find(".ab").css(t.cir).find(".cir").css(t.cirCover).find(".perc").css(t.percent), i.append(g), setTimeout(function() {
                    o(c, parseInt(d), g.find(".ab"))
                }, 250)
            })
        }
    })
