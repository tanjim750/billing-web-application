...
SECRET_KEY = 'django-insecure-wgaiqiwe8o78t9wv8p^cz&ct=hio848l!oj!afyqyx7%%8#yrp'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'u747710383_royalplaza',  
        'USER': 'u747710383_royalplaza',  
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static')  # Ensure any app-level static files are included
]
